Public Class Form1
    ...
    End Sub
    Private Sub gsearch_Click(sender As Object, e As EventArgs) Handles gsearch.Click
        browser.Navigate("https://google.com/search?q=" + searchinput.Text)
    End Sub

    Private Sub urlsearch_Click(sender As Object, e As EventArgs) Handles urlsearch.Click
        browser.Navigate(searchinput.Text)
    End Sub
    ...
    End Sub
End Class
'Default WidthxHeight is 816, 489
'Resizer, used to resize the window
'-------------------------------------------------------------------------------
' Resizer
